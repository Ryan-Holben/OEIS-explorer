...
- [ ] Add a dark/light/system toggle button to the top right
...
- [ ] Make sure the hover tooltip on the plot preview never overlaps the plot line
- [ ] Make the string for recently added time, e.g. "1 Months Ago" properly use plural or singular to be gramatically correct.  On hover, show the actual date.